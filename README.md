...
- *2025-12-20* 新增了裁剪功能，在模板匹配时可以只匹配截图的一部分，略微提升速度和准确度。裁剪范围，基准窗口大小，模板路径现在可以在templat_img.py文件中配置。裁剪范围可以使用image_cropper.py获取。由于在全屏窗口化时游戏窗口会被拉伸，导致裁剪范围有偏差，所以在1920x1080分辨率下重新截取了所有模板
